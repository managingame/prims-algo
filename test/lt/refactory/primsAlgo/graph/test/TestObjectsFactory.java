 ...
 public class TestObjectsFactory {
	 ...
	 static List<Node> nodesFactory()
	 {
		 List<Node> nodeList = new ArrayList<Node>();
			 ...
			 nodeList.add(new Node(pointsToXArray[5],pointsToYArray[4])); // 3[-6.0; 0.5];
			 ...
			 nodeList.add(new Node(pointsToXArray[5],pointsToYArray[1])); // 6[ 1.2; 2.0];
			 nodeList.add(new Node(pointsToXArray[5],pointsToYArray[1])); // 7[ 1.2; 2.0];
	 ...
	 static List<Edge> edgeFactory(){
		...
		edgeList.add(new Edge(nodeList.get(6),nodeList.get(1)));
		edgeList.add(new Edge(nodeList.get(6),nodeList.get(5)));
		edgeList.add(new Edge(nodeList.get(4),nodeList.get(5)));
		edgeList.add(new Edge(nodeList.get(6),nodeList.get(2)));
		edgeList.add(new Edge(nodeList.get(3),nodeList.get(2)));
		edgeList.add(new Edge(nodeList.get(8),nodeList.get(0)));
